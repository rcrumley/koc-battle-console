...
function btStartup (){
	...
	mainPop.getTopDiv().innerHTML = '<DIV align=center><B>Battle Monitor (Lite)</B></DIV>';

	m = '<STYLE>'+ styles +'</style>';
  
	m += '<div id="btMain_content">';
	m += '<br>';
	m += '<div align="center">&nbsp;&nbsp;Enemy:&nbsp;<INPUT id=btPlayer size=20 type=text value="'+Options.LastMonitored+'"/>&nbsp;<a id=btPlayerSubmit class="inlineButton btButton blue20"><span>Monitor</span></a>&nbsp;<a id=btUIDSubmit class="inlineButton btButton blue20"><span>UID</span></a></div>';
	...
	document.getElementById('btOptionLink').addEventListener ('click', function () {ToggleDivDisplay("btMain",110,400,"btOption")}, false);
...
function AlterUWFuncs() {
	...
	for (jj in uW.cm.ContextMenuMapController.prototype.MapContextMenus.City) {
		if (jj != 5) uW.cm.ContextMenuMapController.prototype.MapContextMenus.City[jj].push("MONI"); }
