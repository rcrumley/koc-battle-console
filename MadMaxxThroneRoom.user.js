...
function trStartup (){
	...
	maxTrLevel = unsafeWindow.cm.MAX_MASTERS_TOKEN_LEVEL;
    ...
    var styles = '.xtab {padding-right: 5px; border:none; background:none; white-space:nowrap;}\
		...
		.aquaBorder { margin-right: -100%; margin-bottom: -100%; height: 72%; width: 72%; padding: 4%; border: 3px solid aqua; background: transparent;}\
		.blackBorder { margin-right: -100%; margin-bottom: -100%; height: 72%; width: 72%; padding: 4%; border: 3px solid black; background: transparent;}\
		.crimsonBorder { margin-right: -100%; margin-bottom: -100%; height: 72%; width: 72%; padding: 4%; border: 3px solid crimson; background: transparent;}\
		.forestgreenBorder { margin-right: -100%; margin-bottom: -100%; height: 72%; width: 72%; padding: 4%; border: 3px solid forestgreen; background: transparent;}\
		.fuchsiaBorder { margin-right: -100%; margin-bottom: -100%; height: 72%; width: 72%; padding: 4%; border: 3px solid fuchsia; background: transparent;}\
		.greenBorder { margin-right: -100%; margin-bottom: -100%; height: 72%; width: 72%; padding: 4%; border: 3px solid cyan; background: transparent;}\
		.khakiBorder { margin-right: -100%; margin-bottom: -100%; height: 72%; width: 72%; padding: 4%; border: 3px solid khaki; background: transparent;}\
		.limeBorder { margin-right: -100%; margin-bottom: -100%; height: 72%; width: 72%; padding: 4%; border: 3px solid lime; background: transparent;}\
		.maroonBorder { margin-right: -100%; margin-bottom: -100%; height: 72%; width: 72%; padding: 4%; border: 3px solid maroon; background: transparent;}\
		.orangeBorder { margin-right: -100%; margin-bottom: -100%; height: 72%; width: 72%; padding: 4%; border: 3px solid orange; background: transparent;}\
		.purpleBorder { margin-right: -100%; margin-bottom: -100%; height: 72%; width: 72%; padding: 4%; border: 3px solid purple; background: transparent;}\
		.redBorder { margin-right: -100%; margin-bottom: -100%; height: 72%; width: 72%; padding: 4%; border: 3px solid red; background: transparent;}\
		.salmonBorder { margin-right: -100%; margin-bottom: -100%; height: 72%; width: 72%; padding: 4%; border: 3px solid salmon; background: transparent;}\
		.silverBorder { margin-right: -100%; margin-bottom: -100%; height: 72%; width: 72%; padding: 4%; border: 3px solid silver; background: transparent;}\
		.siennaBorder { margin-right: -100%; margin-bottom: -100%; height: 72%; width: 72%; padding: 4%; border: 3px solid sienna; background: transparent;}\
		.skyblueBorder { margin-right: -100%; margin-bottom: -100%; height: 72%; width: 72%; padding: 4%; border: 3px solid skyblue; background: transparent;}\
		.slateblueBorder { margin-right: -100%; margin-bottom: -100%; height: 72%; width: 72%; padding: 4%; border: 3px solid slateblue; background: transparent;}\
		.slategrayBorder { margin-right: -100%; margin-bottom: -100%; height: 72%; width: 72%; padding: 4%; border: 3px solid slategray; background: transparent;}\
		.tealBorder { margin-right: -100%; margin-bottom: -100%; height: 72%; width: 72%; padding: 4%; border: 3px solid teal; background: transparent;}\
		.whiteBorder { margin-right: -100%; margin-bottom: -100%; height: 72%; width: 72%; padding: 4%; border: 3px solid white; background: transparent;}\
		.yellowgreenBorder { margin-right: -100%; margin-bottom: -100%; height: 72%; width: 72%; padding: 4%; border: 3px solid yellowgreen; background: transparent;}\
...
function installHandlerFunctions() {
    ...
    var ri2 = function(l) {
		...
		*/
		...
		for (ii in tagData.itemColorList) {
			var itemColor = tagData.itemColorList[ii];
			if ( itemColor.preset==Seed.throne.activeSlot) {
				$("div#throneInventoryItem" + itemColor.itemId).prepend("<div class='"+itemColor.color+"Border'></div>");
			}
		}
		
		if (tagData.showUtag == true) {
			for (ii in tagData.itemColorList) {
				var itemColor = tagData.itemColorList[ii];
				if ( itemColor.preset==0) {
					$("div#throneInventoryItem" + itemColor.itemId).prepend("<div class='"+itemColor.color+"Border'></div>");
				}
			}		
		}
    ...
    // save the location of the old function
    ...
    var renderMenu2 = function (l, j) {
        ...
        if (j != null)
        {
			...
			if (ptagLevel == 0) {
				...
				.css('color', 'white')
				.bind("click", function () {
					Tabs.tags.addTagItem(j.id, Seed.throne.activeSlot);
					$("#contextMenu").remove();});
					$("#contextMenu div.title").after(btn4);
			} else {
				var btn4 = document.createElement('a');
				$(btn4).addClass("buttonv2 h20 brown")
				.html("Remove Preset Tag")
				.css('color', 'white')
				.bind("click", function () {
					Tabs.tags.removeTagItem(j.id, Seed.throne.activeSlot);
					$("#contextMenu").remove();});
					$("#contextMenu div.title").after(btn4);
			}
			...
			if (utagLevel == 0) {
				...
				.css('color', 'white')
				.bind("click", function () {
					Tabs.tags.removeTagItem(j.id, 0);
					$("#contextMenu").remove();});
					$("#contextMenu div.title").after(btn3);
			}
...
function saveTagData (){
    var serverID = getServerId();
    setTimeout (function (){GM_setValue ('TagDataMM2_'+serverID, JSON2.stringify(tagData));}, 0);
}
...
function readTagData (){
    var serverID = getServerId();
    s = GM_getValue ('TagDataMM2_'+serverID);
    if (s != null){
        opts = JSON2.parse (s);
        for (k in opts){
            if (matTypeof(opts[k]) == 'object')
                for (kk in opts[k])
                    tagData[k][kk] = opts[k][kk];
            else
                tagData[k] = opts[k];
        }
    }
...
Tabs.organizer = {
        ...
        init : function (div){
            ...
            m += '</select></span></div></td>';
            m += '<td><INPUT id=testSalvage type=button value=" Test Salvage "/></td><td id=trDelResults></td>';
            m += '</tr>';
            ...
            m += "<tr align=center valign=top><th width=5%>Chairs</th><th width=5%>Tables</th><th width=5%>Windows</th><th width=5%>Banners</th><th width=5%>Advisors</th><th width=5%>Trophies</th><th width=5%>Candelabra</th><th width=5%>Heroes</th><th width=5%>Statues</th><th width=5%>Pets</th><th width=5%>Tapestry</th><th width=5%>Pillar</th></tr>";
            m += '</table></div>';
            m += '</div>';
            m += '</div>';
        ...
        paintTable : function() {
            ...
            m += "<tr align=center valign=top><th width=5%>Chairs</th><th width=5%>Tables</th><th width=5%>Windows</th><th width=5%>Banners</th><th width=5%>Advisors</th><th width=5%>Throphies</th><th width=5%>Candelabra</th><th width=5%>Heroes</th><th width=5%>Statues</th><th width=5%>Pets</th><th width=5%>Tapestry</th><th width=5%>Pillar</th></tr>";
            for (var k= 0; k < ii ; k++)
            {
			...
			*/
			...
			for (ii in tagData.itemColorList) {
				var itemColor = tagData.itemColorList[ii];
                $("div#trCardItem" + itemColor.itemId).find("div.trCard").append("<div class='"+itemColor.color+"Border'></div>");
            }
...
Tabs.tags = {
		...
		init : function (div){
			...
			//universal tag section
			m += '<tr><td>Current Tag Color: <select id=trUTagColor>';
			m += '<option value="aqua">Aqua</option>';
			m += '<option value="black">Black</option>';
			m += '<option value="crimson">Crimson</option>';
			m += '<option value="forestgreen">Forest Green</option>';
			m += '<option value="fuchsia">Fuchsia</option>';
			m += '<option value="khaki">Khaki</option>';
			m += '<option value="lime">Lime</option>';
			m += '<option value="maroon">Maroon</option>';
			m += '<option value="orange">Orange</option>';
			m += '<option value="purple">Purple</option>';
			m += '<option value="red">Red</option>';
			m += '<option value="salmon">Salmon</option>';
			m += '<option value="sienna">Sienna</option>';
			m += '<option value="silver">Silver</option>';
			m += '<option value="skyblue">Sky Blue</option>';
			m += '<option value="slateblue">Slate Blue</option>';
			m += '<option value="slategray">Slate Gray</option>';
			m += '<option value="teal">Teal</option>';
			m += '<option value="white">White</option>';
			...
			//preset tag section
			m+= '<tr><td width= 30px>Tag Preset: </td>';
            
			for (a=1; a <=  Seed.throne.slotNum; a++)
				{
					m += '<td width= 30px><a style="font-family: serif; width: 25px" class="button20 setPresetTag"  id=trPresetTag'+ a + ' > <span> <center> ' + a + ' </center> </span></a></td>';  
				}
            m += '</tr>';
			m+= '<tr><td width= 30px>Remove Tags: </td>';
            
			for (a=1; a <=  Seed.throne.slotNum; a++)
				{
					m += '<td width= 30px><a style="font-family: serif; width: 25px" class="buttonDown20 removePresetTag"  id=trRemovePresetTag'+ a + ' > <span> <center> ' + a + ' </center> </span></a></td>';  
				}
            m += '</tr></table>';
			m += '<br/><hr/><br/>';
			m += '<TABLE width=100% class="trTable">';
			m += '<tr><td><INPUT id=clearColorTags type=button value=" Clear All Current Color Tags "/></td><td><INPUT id=clearUTags type=button value=" Clear Universal Tags "/></td><td><INPUT id=clearAllTags type=button value=" Clear All Tags "/></td></tr>';
			m +='</table></div>';
			...
			//Control functions
			$("#trUTagColor").val(tagData.uColor);
            $("#trUTagColor").change( function() { tagData.uColor = $("#trUTagColor").val(); saveTagData();});
			...
			$(".setPresetTag").click( function () {
                var id= $(this).attr('id');
                t.presetTagAdd(+id.split("trPresetTag")[1]);
            });
			
			$(".removePresetTag").click( function () {
                var id= $(this).attr('id');
                t.presetTagRemove(+id.split("trRemovePresetTag")[1]);
            });
			
			$('#chkTagShow').change( function (){
                tagData.showUtag = document.getElementById('chkTagShow').checked;
                saveTagData();
            }
            );
...
//moved original add and remove tag functions from organizer section to new tag section		
		addTagItem : function (itemId, presetId) {
            /*
            ...
            savePresetData();
			*/
			var itemColor1 = new itemColor (itemId, tagData.uColor, presetId);
			tagData.itemColorList.push (itemColor1);
			$("#throneInventoryItem" + itemId).prepend("<div class='"+tagData.uColor+"Border'></div>");
            $("div#trCardItem" + itemId).find("div.trCard").append("<div class='"+tagData.uColor+"Border2' style='border: 8px solid " + tagData.uColor +"; background: none; width: 184px; height: 288px;'></div>");
			saveTagData();
        },

        removeTagItem : function (itemId, presetId) {
			for (var i=0; i < tagData.itemColorList.length; i++) {
				if ( itemId == tagData.itemColorList[i].itemId && presetId == tagData.itemColorList[i].preset) {
					$("#throneInventoryItem" + itemId).children("."+tagData.itemColorList[i].color+"Border").remove();
					$("#trCardItem" + itemId + " div."+tagData.itemColorList[i].color+"Border2").remove();
					tagData.itemColorList.splice(i,1);
					saveTagData();
					break;
				}
			}
		...
		presetTagAdd : function(presetId) {
            ...
            if (equipedItems != null) {
                for (i =0; i < equipedItems.length; i++) {
					var isTagged=new Boolean();
					
					for (var x=0; x < tagData.itemColorList.length; x++) {
						if ( equipedItems[i] == tagData.itemColorList[x].itemId) {
							isTagged = true;
							break;
						}
					}
					...
					if (isTagged != true) {
						t.addTagItem(equipedItems[i], presetId);	
					}
                }
            }
		},
		...
		presetTagRemove : function(presetId) {
			...
			for (var x=0; x < tagData.itemColorList.length; x++) {
				...
				if ( itemColor.preset == presetId) {
					t.removeTagItem(itemColor.itemId, itemColor.preset);
					//reduce counter due to splice in removeTagItem function
					x--;
				}
			}
		...
		clearColorTags : function () {
			...
			for (var x=0; x < tagData.itemColorList.length; x++) {
				...
				if ( itemColor.color == tagData.uColor) {
					t.removeTagItem(itemColor.itemId, itemColor.preset);
					//reduce counter due to splice in removeTagItem function
					x--;
				}
        ...
        clearAllTags : function() {
			for (k in tagData.itemColorList) {
                var tag_item = tagData.itemColorList[k];
				$("#throneInventoryItem" + tag_item.itemId).children("."+tag_item.color+"Border").remove();
				$("#trCardItem" + tag_item.itemId + " div."+tag_item.color+"Border2").remove();
			}
			
			for (var i=0; i < tagData.itemColorList.length;) {
				tagData.itemColorList.shift();
			}
...
function itemColor (itemId, color, preset) {
	this.itemId = itemId;
	this.color = color;
	this.preset = preset;
}
