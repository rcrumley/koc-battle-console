...
// @releasenotes 	<p>Fix city "jumping" when using auto-replace</p><p>Move Image URLs to RockYou Servers</p>
// ==/UserScript==
...
var Options = {
	...
	OverrideDashboard   : {},
	MonitorFontSize		: 11,
	UpdateLocation      : 1, // 0 - Userscripts, 1 - Googlecode, 2 - Greasyfork
	USPort              : 8080,
...
if (typeof SOUND_FILES.timeout == 'undefined'){
	...
	SOUND_FILES.timeout.DEFAULT = '<span><object type="application/x-shockwave-flash" data="http://koc.god-like.org/power/swf/pdxminiplayer.swf" width="160" height="20"><param name="wmode" value="transparent" /><param name="movie" value="http://koc.god-like.org/power/swf/pdxminiplayer.swf" /><param name="flashvars" value="mp3=http://svn.code.sf.net/p/koc-battle-console/code/trunk/sounds/arrow.mp3&amp;autostart=1&amp;showtime=1&amp;volume=100" /></object></span>';
}
if (typeof SOUND_FILES.monitor == 'undefined'){
	...
	SOUND_FILES.monitor.DEFAULT = '<span><object type="application/x-shockwave-flash" data="http://koc.god-like.org/power/swf/pdxminiplayer.swf" width="160" height="20"><param name="wmode" value="transparent" /><param name="movie" value="http://koc.god-like.org/power/swf/pdxminiplayer.swf" /><param name="flashvars" value="mp3=http://svn.code.sf.net/p/koc-battle-console/code/trunk/sounds/DoorBell.mp3&amp;autostart=1&amp;showtime=1&amp;volume=100" /></object></span>';
}
